...
const ShoppingAmount = ({checkout, setCheckout}) => {
  ...
  return (
    <div className="shopping-amount">
      ...
      <div className="result">
        ...
        <span className="result-text">{totalPrice - totalDiscount + taxPrice}</span>
      </div>
      ...
      {checkout ? <Link to={'/payment'}><button className="checkout-btn" >Checkout</button></Link> : <button className="checkout-btn" onClick={() => setCheckout(true)} disabled={disabled}>Checkout</button>}
